                ...
                <div className="bg-white rounded-2xl shadow-xl p-8 space-y-8">
                    ...
                    <div className="text-center">
                        ...
                        <p className="mt-3 text-base text-gray-500/90">
                            Sign in to access your lung cancer detection dashboard and AI analysis results.
                        </p>
                    </div>
                    ...
                    <div className="text-center pt-4 border-t border-gray-100">
                        <p className="text-gray-600">
                            ...
                            <a href="/signup" className="text-violet-600 font-medium hover:text-violet-700 hover:underline transition-colors">
                                Sign up
                            </a>
                        </p>
                    </div>
